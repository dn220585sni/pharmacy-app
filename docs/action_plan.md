...
### ☐ B7. Періодичний flush черги ПРРО
Таймер (напр., кожні 60 с при непорожній черзі) + індикатор кількості відкладених чеків в UI.
- Файли: `lib/services/prro_queue.dart`, `lib/main.dart:35-39`
...
6. **D6**: виправлення битого JSON у 5 сервісах.
