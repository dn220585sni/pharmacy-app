...
///
/// ⚠️ **ВІДКРИТЕ ГОЛОВНЕ: звідки брати PAN.**
///
/// `Purchase` віддає лише маскований номер («4731XXXXXXXX9838»), з якого
/// девʼять цифр Катериного прикладу не зібрати. Повний номер БЕЗ списання
/// дає `ReadBonusCard` (ECR 5.22):
...
///
/// Тобто джерела номера в нас зараз немає. Поки воно не визначене,
/// підключати гейт до оплати не можна: помилка тут коштує заблокованої каси.
///
/// Наступний крок — питання Катерині: з якої операції вона очікує PAN, бо
/// сервіс проєктувався під якесь конкретне джерело.
