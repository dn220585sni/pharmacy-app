...
class CashExpensesService {
  ...
  ///
  /// ⚠️ Що таке «ЖУК» — НЕ зʼясовано. Це дослівний маркер з опису Катерини,
  /// і більше він ніде не зустрічається; Микола 04.09 сказав, що чує його
  /// вперше. Це точно НЕ програма лояльності (вона зветься ЛАЙК) — я був
  /// припустив саме це й помилився. Тут ми покладаємось лише на форму
  /// запису, не на значення терміна, тож код коректний; але перш ніж
  /// спиратись на «ЖУК» деінде — спитати Катерину, що воно означає.
