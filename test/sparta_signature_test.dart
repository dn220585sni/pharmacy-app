...
void main() {
  group('SpartaSignature.compute (doc 1.6.3 example)', () {
    ...
    // УВАГА (TZ-неоднозначність): encodeDateMs дає КОРЕКТНИЙ ISO→UTC ms.
    // Для 13:14:15+02:00 це 1672571655000 (11:14:15 UTC). Док у прикладі
    // використовує 1672575255000 (12:14:15 UTC, тобто +01:00). Перед бойовим
    // запуском ЗВІРИТИ з demo-сервером Спарти, яку TZ-конвенцію він очікує.
