...
/// Quick script to call GetInfoSetup on the Caché server and print the raw response.
/// Run: dart run tool/call_get_info_setup.dart
...
void main() async {
  ...
  try {
    ...
    // Try UTF-8 first, fallback to raw bytes display
    String body;
    try {
